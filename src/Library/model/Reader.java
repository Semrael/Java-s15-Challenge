...
public class Reader extends Person {
    ...
    public void purchase_book(Book book){
        if(book != null){
            System.out.println(getName()+ ", "+ book.getTitle()+ "kitabını satın aldı.");
        }
        else{
    ...
    public void borrow_book(Book book){
        if(book != null){
            System.out.println(getName()+", " +book.getTitle()+ " kitabını ödünç aldı");
            books.add(book);
        }
        else{
            System.out.println("Kütüphanemizde bu kitap yok.");
    ...
    public void return_book(Book book){
        if(books.contains(book)){
            books.remove(book);
            System.out.println(book.getTitle()+ "kütüphaneye iade edildi.");
        }
        else{
