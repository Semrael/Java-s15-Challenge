...
//        book5.display();
        Book book1=new Book(0001,"Kızıla Boyalı Saçlar",new Author("Kostas Mourselas"),"12.12.1222",123,true,"1. Baskı","12-12-1222");
        Book book2=new Book(0002,"Çankaya",new Author("Falih Rıfkı Atay"),"12.12.1222",123,true,"9. Baskı","12-12-1222");
        Book book3=new Book(0003,"Hüzün Nedeniyle kapalıyız",new Author("Kostas Mourselas"),"12.12.3222",123,false,"6. Baskı","12-12-1222");
        Book book4=new Book(0004,"Beyoğlu'nun En Güzel Abisi",new Author("Ahmet Ümit"),"12.12.3222",123,true,"6. Baskı","12-12-1222");
        Book book5=new Book(0005,"Hurinin Çocukları",new Author("J.R.R. Tolken"),"12.12.3222",123,true,"6. Baskı","12-12-1222");
        book5.display();
      ...
      librarian.searchBook("Hurinin Çocukları",books);
      librarian.issueBook(book5,reader1);
